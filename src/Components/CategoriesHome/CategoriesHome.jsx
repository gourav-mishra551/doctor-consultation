...
function CategoryCard({ item, navigate }) {
  return (
    ...
    >
      <div className="cardio w-[220px] sm:h-[200px] sm:w-[260px] flex flex-col justify-between items-center bg-[#e4f8f6] rounded-3xl hover:bg-white hover:border-2 hover:border-[#1c8e81] transition-transform duration-300 transform hover:-translate-y-2 shadow-lg mt-[30px]">
        {/* Image Container */}
