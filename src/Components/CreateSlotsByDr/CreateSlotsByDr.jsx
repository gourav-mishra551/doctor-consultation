...
const CreateSlotsByDr = () => {
  ...
  const generateSlots = () => {
    ...
    // Check each field and add error messages if empty
    if (!visitingMode) errors.visitingMode = "Visiting Mode is required.";
    if (!availableTimeFrom)
      errors.availableTimeFrom = "Start time is required.";
    if (!availableTimeTo) errors.availableTimeTo = "End time is required.";
    if (!selectSlotDuration)
      errors.selectSlotDuration = "Slot duration is required.";
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg mx-auto">
                <div className="text-center">
                  ...
                  <p className="text-red-600 text-lg">
                    You haven't added your hospital/clinic details. Please add
                    it first.
                  </p>
                  <div className="mt-4">
                    <button
          ...
          <div className="p-6  mx-auto bg-white rounded-lg shadow-lg">
            ...
            <div className="mb-6 flex gap-4">
              <div className="w-1/2">
                ...
                />
                {validationErrors.availableTimeFrom && (
                  <p className="text-red-500 text-sm mt-1">
                    {validationErrors.availableTimeFrom}
                  </p>
                )}
              ...
              <div className="w-1/2">
                ...
                />
                {validationErrors.availableTimeTo && (
                  <p className="text-red-500 text-sm mt-1">
                    {validationErrors.availableTimeTo}
                  </p>
                )}
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4">
              <div className="w-full">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-[#4BAAB3]-500 transition duration-300"
                />
                {validationErrors.selectSlotDuration && (
                  <p className="text-red-500 text-sm mt-1">
                    {validationErrors.selectSlotDuration}
                  </p>
                )}
