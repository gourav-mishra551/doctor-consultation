...
const DoctorsProfile = () => {
    ...
    return (
        <div>
            <div className="h-[300px] bg-cover opacity-100 bg-no-repeat flex flex-col justify-center items-center" style={{
            ...
            <div className='max-w-7xl mx-auto mt-10 flex gap-10'>
                ...
                <div className='w-[auto] sm:w-[85%] flex flex-col gap-10' >
                    <div className="dr-profile-section hidden  h-[280px] bg-[#f3f3f3] p-10  justify-between" style={{ border: "1px solid red" }}>
                        ...
                        <div className='ratings ml-[50px] sm:ml-[0px] h-[150px] sm:h-[auto]'>
                            ...
                            <div className='flex  gap-3 sm:mt-[15px] sm:mr-[200px] sm:flex sm:flex-col sm:ml-[0px] sm:w-[250px] mt-[55px]  w-[250px] center ml-[0px] justify-between'>
                                <button className='h-[35px]   w-[100px] text-sm/[17px] sm:w-[200px] border-2 border-blue-700 hover:bg-[#1977cc] hover:text-white transition-all ease-in-out duration-300 delay-150 '>VIEW PROFILE</button>
                                <button className='h-[35px] w-[100px] text-sm/[17px] sm:w-[200px] text-white bg-[#1977cc] border-2 border-blue-700'>BOOK APPOINTMENT</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='sm:hidden block'>
                            <div className='flex justify-center items-center p-2 space-x-10'>
                                ...
                                <div className="dr-profilee">
                                    <p className='text-blue-800 font-bold text-[27px]'>Dr Tripti Deb</p>
                                    <p className='text-blue-800 font-semibold text-[21px]' style={{ fontWeight: "bolder" }}>Cardiologist</p>
                                    <p style={{ fontWeight: "bold" }} className='text-[21px] text-gray-500'>Urology</p>
                                    <p style={{ fontWeight: "bold" }} className='text-[21px] text-gray-500'>40 Years MBBS,MD,DM,FACC</p>
                                    <p style={{ fontWeight: "bold" }} className='text-[21px]'>Dermatologist</p>
                                </div>
                            </div>

                            <div className='mb-3' style={{ display: "flex", justifyContent: "center", marginTop: "30px", gap: "60px" }}>
                                <button style={{ border: "1px solid black", padding: "10px", fontWeight: "bolder", borderRadius: "10px", height: "70px", width: "200px", fontSize: "23px" }}>Digital Consult</button>
                                <button className='bg-[#1977CC] hover:bg-[#2c91e9] transition-all duration-300 ease-in-out' style={{ border: "1px solid black", padding: "10px", fontWeight: "bolder", borderRadius: "10px", color: "white", height: "70px", width: "200px", fontSize: "23px" }}>Hospital Visit</button>
                            </div>
                        </div>
                    </div>
