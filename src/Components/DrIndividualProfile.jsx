    ...
    return (
        <div>
            ...
            <div className='sm:max-w-6xl w-full mx-auto mt-10 gap-10'>
                ...
                {/* <div className="dr-profile-section mb-10 w-full sm:h-[270px] h-auto bg-[#f3f3f3] p-10 flex sm:flex-row flex-col justify-between" style={{border:"1px solid red"}}>
                    <div className='flex sm:gap-5 gap-2'>
                        <div className="img bg-[#f3f3f3] flex justify-center items-center h-[150px] w-[150px] rounded-full">
                            <img src="dr-prof-1.webp" alt="dr-image" className='h-[130px] w-[130px] rounded-full' />
                        </div>
