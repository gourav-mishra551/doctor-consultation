...
// const EditQualificatinDetails = ({ doctorData }) => {
...
//   console.log("qulaifincatiopj", doctorData);
...
//       {doctorData?.data?.qualifications?.map((experience, index) => (
//         <div key={index}>
//           {/* Toggle Button */}
//           <button
...
//               {/* Employment Type */}
//               <div className="flex flex-col gap-1">
//                 <label className="px-2 font-bold">Institute Name</label>
//                 <input
//                   type="text"
...
//               {/* Job Title */}
//               <div className="flex flex-col gap-1">
//                 <label className="px-2 font-bold">Field of Study</label>
//                 <input
//                   type="text"
...
// export default EditQualificatinDetails;
