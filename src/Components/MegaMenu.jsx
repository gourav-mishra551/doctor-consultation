              ...
              {submenuData[hoveredItem].map((subItem, index) => (
                <div key={index} className='flex align-top'>
                  <div className='flex items-center justify-center'>
                    {subItem === 'Cardiology' && <img src='src/Assests/heart-attack.png' className="h-10 w-10" />}
                    {subItem === 'Orthopedics' && <img src='src/Assests/x-ray.png' className="h-10 w-10" />}
                    {subItem === 'Spine' && <img src='src/Assests/chiropractic.png' className="h-10 w-10" />}
                    {subItem === 'Neurology' && <img src='src/Assests/neurology.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Gastroenterology' && <img src='src/Assests/stomach.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Oncology' && <img src='src/Assests/cancer-cell.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'TransPlant' && <img src='src/Assests/kidneys.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'ICU' && <img src='src/Assests/emergency.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Emergency' && <img src='src/Assests/emergency-room.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Preventive Health' && <img src='src/Assests/anti-virus.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Robotics' && <img src='src/Assests/robot.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Bariatric Surgery' && <img src='src/Assests/back.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Nephrology and Urology' && <img src='src/Assests/support.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Colorectal Surgery' && <img src='src/Assests/colorectal-surgery.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Obstetrics and Gynaecology' && <img src='src/Assests/obstetrics.png' className='inline mr-2 h-10 w-10' />}
                    {subItem === 'Pulmonology' && <img src='src/Assests/pulmonology.png' className='inline mr-2 h-10 w-10' />}
                  </div>
                  <div>
