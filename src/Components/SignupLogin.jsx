                            ...
                            <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5" >
                                ...
                                <div className="w-full">
                                    ...
                                    <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                                        <div>
                                            <label className="block mb-2 text-sm text-[#1c8e81] font-bold">Full Name</label>
                                            <input type="text"
                                                name="name"
                                        ...
                                        <div>
                                            <label className="block mb-2 text-sm text-[#1c8e81] font-bold">Gender</label>
                                            <select
                                                name="gender"
                                                placeholder="John Snow"
                                                value={values.gender}
                                        ...
                                        <div>
                                            <label className="block mb-2 text-sm text-[#1c8e81] font-bold">Phone number</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block mb-2 text-sm text-[#1c8e81] font-bold">Confirm password</label>
                                            <input
                                                type="password"
