...
const UserProfile = () => {
    ...
    const headerStyle = {
        minHeight: '600px',
        backgroundImage: 'url(https://img.freepik.com/free-photo/doctor-nurses-special-equipment_23-2148980721.jpg?w=826&t=st=1714628622~exp=1714629222~hmac=799a2c386c8f32ea40eb55d32930ee70fd106d99b79632255205ca9a6b116108',
                ...
                <div className="container-fluid d-flex align-items-center">
                    <div className="row">
                        <div className="col-lg-7 col-md-10">
                            ...
                            <a href="#!" className="btn btn-info bg-[#1c8e81] border-none">Edit profile</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <Sidebar>
                            <Menu>
                                <SubMenu className='font-bold' label="Profile">
                                    <MenuItem component={<NavLink to="/home"></NavLink>}> Profile </MenuItem>
                                    <MenuItem component={<NavLink to="/home"></NavLink>}> Home </MenuItem>
                                </SubMenu>
                            ...
                            <div className="card card-profile shadow">
                                ...
                                <div className="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                                    <div className="d-flex justify-content-between">
                                        <button href="#" className="btn btn-sm btn-info mr-4 bg-[#1c8e81]">My account</button>
                                        <a href="#" className="btn btn-sm btn-default float-right">Setting</a>
                                    </div>
                                </div>
