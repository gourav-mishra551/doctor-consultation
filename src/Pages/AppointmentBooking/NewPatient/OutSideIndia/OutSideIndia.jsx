        ...
        <div className='flex flex-col border-y-2 h-min border-gray-600 w-[40%]'>
            <Link to="/categories">
                <div className='py-6 hover:cursor-pointer'>
                    ...
                    <p className='text-lg text-gray-400 font-medium my-4 flex justify-between mt-2 gap-5'> <SlArrowRight className='text-xl text-[#1C8E81]' />Get consultation at your home with our service. </p>
                </div>
            </Link>
            ...
            <Link to="https://ametheushealth.com/international-patient-services">
                <div className=' border-t-2 py-6 border-gray-600 hover:cursor-pointer'>
                    ...
                    <p className='text-lg text-gray-400 font-medium my-4 flex justify-between mt-2 gap-5'> For Offline consultation you need to visit India , we will take care of your all medical tour. <SlArrowRight className='text-xl text-[#1C8E81]' /></p>
                </div>
            </Link>
